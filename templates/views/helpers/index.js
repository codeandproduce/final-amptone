...
module.exports = function () {
	...
	* */
	...
	//album string manipulation
	// _helpers.grabAlbumSoundcloudURL = function(string){
	// 	var indexOfSemiColon = string.indexOf(";");
	// 	var finalString = string.slice(0,(indexOfSemiColon-1));
	// 	return finalString;
	// }
